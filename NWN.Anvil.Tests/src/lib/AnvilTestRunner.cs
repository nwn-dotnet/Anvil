...
namespace Anvil.Tests
{
    ...
    /// </summary>
    public class AnvilTestRunner : ITestListener
    {
        ...
        /// </summary>
        public AnvilTestRunner(Assembly testAssembly)
        {
        ...
        private int Execute()
        {
            ...
            try
            {
                ...
                if (_options.ErrorMessages.Count > 0)
                {
                    ...
                    return AnvilTestRunner.INVALID_ARG;
                }
        ...
        public static Dictionary<string, object> MakeRunSettings(NUnitLiteOptions options)
        {
            ...
            // ANVIL BEGIN: Disable threaded workers and force single threaded mode:
