...
namespace Anvil.Tests.API
{
  public sealed class NuiImageTests
  {
    ...
    public void SerializeNuiImageReturnsValidJson()
    {
      ...
      Assert.That(JsonUtility.ToJson<NuiElement>(element), Is.EqualTo("""{"image_halign":2,"image_aspect":4,"image_region":null,"value":"gui_chr_arrowbtn","type":"image","image_valign":0,"height":16.0,"margin":0.0,"width":16.0}"""));
    }
  }
}
