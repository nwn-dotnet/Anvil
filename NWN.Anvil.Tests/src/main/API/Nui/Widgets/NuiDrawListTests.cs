...
namespace Anvil.Tests.API
{
  ...
  public sealed class NuiDrawListTests
  {
    ...
    public void SerializeNuiDrawListArcReturnsValidJsonStructure()
    {
      ...
      Assert.That(JsonUtility.ToJson(drawListArc), Is.EqualTo("""{"amax":170,"amin":90,"c":{"x":1,"y":2},"radius":2,"type":3,"color":{"a":255,"b":170,"g":170,"r":255},"enabled":false,"fill":true,"line_thickness":1,"order":1,"render":0}"""));
    }
    ...
    public void SerializeNuiDrawListCircleReturnsValidJsonStructure()
    {
      ...
      Assert.That(JsonUtility.ToJson(drawListCircle), Is.EqualTo("""{"rect":{"h":4,"w":3,"x":1,"y":2},"type":2,"color":{"a":255,"b":170,"g":170,"r":255},"enabled":false,"fill":true,"line_thickness":1,"order":1,"render":0}"""));
    }
    ...
    public void SerializeNuiDrawListCurveReturnsValidJsonStructure()
    {
      ...
      Assert.That(JsonUtility.ToJson(drawListCurve), Is.EqualTo("""{"ctrl0":{"x":9.5,"y":3},"ctrl1":{"x":22,"y":11.3},"a":{"x":10,"y":5},"b":{"x":6,"y":2},"type":1,"color":{"a":255,"b":170,"g":170,"r":255},"enabled":false,"fill":false,"line_thickness":1,"order":1,"render":0}"""));
    }
    ...
    public void SerializeNuiDrawListImageReturnsValidJsonStructure()
    {
      ...
      Assert.That(JsonUtility.ToJson(drawListImage), Is.EqualTo("""{"image_aspect":3,"image_halign":1,"rect":{"h":4,"w":3,"x":1,"y":2},"image":"test_img","type":5,"image_valign":1,"color":null,"enabled":false,"fill":null,"line_thickness":null,"order":1,"render":0}"""));
    }
    ...
    public void SerializeNuiDrawListPolyLineReturnsValidJsonStructure()
    {
      ...
      Assert.That(JsonUtility.ToJson(drawListPolyLine), Is.EqualTo("""{"points":[2,4,6,11],"type":0,"color":{"a":255,"b":170,"g":170,"r":255},"enabled":false,"fill":true,"line_thickness":2,"order":1,"render":0}"""));
    }
    ...
    public void SerializeNuiDrawListTextReturnsValidJsonStructure()
    {
      ...
      Assert.That(JsonUtility.ToJson(drawListText), Is.EqualTo("""{"rect":{"h":8,"w":7,"x":5,"y":6},"text":"Test string","type":4,"color":{"a":255,"b":170,"g":170,"r":255},"enabled":false,"fill":null,"line_thickness":null,"order":1,"render":0}"""));
    }
  }
}
