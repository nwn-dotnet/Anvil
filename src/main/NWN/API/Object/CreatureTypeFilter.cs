...
namespace NWN.API
{
  public struct CreatureTypeFilter
  {
    ...
    public static CreatureTypeFilter PlayerChar(bool isPc)
      => new CreatureTypeFilter(CreatureType.PlayerChar, isPc.ToInt());

    public static CreatureTypeFilter Class(ClassType classType)
      => new CreatureTypeFilter(CreatureType.Class, (int) classType);

    public static CreatureTypeFilter Reputation(ReputationType reputationType)
      => new CreatureTypeFilter(CreatureType.Reputation, (int) reputationType);

    public static CreatureTypeFilter Alive(bool alive)
      => new CreatureTypeFilter(CreatureType.IsAlive, alive.ToInt());

    public static CreatureTypeFilter HasSpellEffect(Spell spellEffect)
      => new CreatureTypeFilter(CreatureType.HasSpellEffect, (int) spellEffect);

    public static CreatureTypeFilter DoesNotHaveSpellEffect(Spell spellEffect)
      => new CreatureTypeFilter(CreatureType.DoesNotHaveSpellEffect, (int) spellEffect);
