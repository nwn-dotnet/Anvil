...
namespace NWN.API
{
  ...
  internal class NativeCampaignVariableConverters : ICampaignVariableConverter<float>, ICampaignVariableConverter<int>, ICampaignVariableConverter<Location>, ICampaignVariableConverter<string>, ICampaignVariableConverter<Vector3>
  {
    ...
    {
      return NWScript.GetCampaignFloat(campaign, name, player.ControlledCreature);
    }
    ...
    {
      return NWScript.GetCampaignInt(campaign, name, player.ControlledCreature);
    }
    ...
    {
      return NWScript.GetCampaignLocation(campaign, name, player.ControlledCreature);
    }
    ...
    {
      return NWScript.GetCampaignString(campaign, name, player.ControlledCreature);
    }
    ...
    {
      return NWScript.GetCampaignVector(campaign, name, player.ControlledCreature);
    }
